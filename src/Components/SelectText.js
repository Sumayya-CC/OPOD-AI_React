              ...
              <div style={{marginTop:'22%', backgroundColor:'#ffffff', height:450, width:'90%',
                ...
                <form onSubmit={this.addTrainingData}>
                    <div style={{textAlign:'center',color:'#D0D0D0',}}>
                        ...
                        <TextField id="outlined-basic" value = {this.props.selected_text} multiline rows = {4} variant="outlined" required
                        InputLabelProps={{required: false,}} style = {{width:'90%', marginTop:'-3%',marginBottom:'3%'}} onChange={this.props.changeSelect}/> 
                    </div>

                    <div>
                        <h4 style = {{color:'#000000',marginTop:'3%',marginLeft:'3%'}}>Offensive Range</h4>
                        <div style={{marginTop:'3%', marginLeft:'5%', width:'100%',}}>
